<template>
    <div class="auth-page">
        <div class="auth-container">
            ...
            <div class="auth-card">
                <h3 class="auth-title">Вход в аккаунт</h3>
                <p class="auth-subtitle">Введите email и пароль для входа</p>
                ...
                <form @submit.prevent="submit" class="auth-form">
                    ...
                    <div class="form-options">
                        <label class="checkbox-label">
                            <input id="remember" v-model="form.remember" type="checkbox" class="checkbox-input">
                    ...
                    <button type="submit" class="submit-button" :class="{ 'button-loading': form.processing }"
                        ...
                        <span class="button-text" v-if="!form.processing">Войти</span>
                        <span class="button-loading-text" v-else>Вход...</span>
                    </button>
                    ...
                    <div class="auth-footer">
                        <p class="footer-text">
                            Нет аккаунта?
                            <Link href="/register" class="footer-link">
                                Зарегистрируйтесь
                            </Link>
                        </p>
                    </div>
